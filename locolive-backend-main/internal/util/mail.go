...
func (m *GmailMailer) SendResetEmail(toEmail string, token string) error {
	...
	// Always log the link to console for easier development/debugging
	fmt.Printf("[DEBUG] Password Reset Link for %s: %s\n", toEmail, resetLink)
	...
	body := fmt.Sprintf(`
		<div style="font-family: sans-serif; max-width: 600px; margin: auto; padding: 20px; border: 1px solid #eee; border-radius: 10px;">
			...
			<div style="background: #f8fafc; padding: 30px; border-radius: 20px;">
				...
				<p style="color: #475569; font-size: 16px; line-height: 1.6;">Click the button below to set a new password. This link expires in 2 minutes.</p>
				<div style="text-align: center; margin: 35px 0;">
					<a href="%s" style="background-color: #FF3B8E; background-image: linear-gradient(to right, #FF3B8E, #A855F7); color: #ffffff !important; padding: 14px 32px; text-decoration: none; border-radius: 14px; font-weight: bold; font-size: 16px; display: inline-block;">Reset Password</a>
				</div>
				<p style="color: #94a3b8; font-size: 12px; text-align: center; margin-top: 20px;">
					If the button doesn't work, copy and paste this link into your browser:<br/>
					<a href="%s" style="color: #FF3B8E;">%s</a>
				</p>
				<p style="color: #94a3b8; font-size: 13px; text-align: center; margin-top: 20px;">If you didn't request this, you can safely ignore this email.</p>
			</div>
	...
	body := fmt.Sprintf(`
		<div style="font-family: sans-serif; max-width: 600px; margin: auto; padding: 20px; border: 1px solid #eee; border-radius: 10px;">
			...
			<div style="background: #f8fafc; padding: 30px; border-radius: 20px;">
				...
				<div style="text-align: center; margin: 35px 0;">
					<a href="%s" style="background-color: #FF3B8E; background-image: linear-gradient(to right, #FF3B8E, #A855F7); color: #ffffff !important; padding: 14px 32px; text-decoration: none; border-radius: 14px; font-weight: bold; font-size: 16px; display: inline-block;">Verify Email</a>
				</div>
